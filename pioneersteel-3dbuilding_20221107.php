...
<div class="wrapperHeader">
	<div class="headerLogo"><img src="http://www.pioneerboys.com/wp-content/themes/pioneersteel/images/header-logo.png" border="0"></div>
		...
		<div id="accordion" >
			<h3>Camera</h3>
		  	<div>
				<p>
				<div>
					<input class="SelectedCamera" type="radio" id="Rotate" name="SelectedCamera" value="arcCamera" checked>
			...
			<h3>Building Size</h3>
		  	<div>
				<p>
					...
					<input style="width:140px" id="BuildingLength" type="range" min="5" max="200" step="1" value="20" >
		  ...
		  <div>
		  	...
		  	<div>
				<p>
					...
					<label for="leanToWidth0" style="padding-right:7px; visibility: hidden;" class="leanto-0">Width</label>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-w" onclick="leanToWidthLeft(0)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-0 leanToInput" id="leanToWidth0" type="text" value="5" disabled>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-e" onclick="leanToWidthRight(0)"></span>
					</br>
					<label for="leanToPitch0" style="padding-right:10px; visibility: hidden;" class="leanto-0">Pitch</label>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-w" onclick="leanToPitchLeft(0)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-0 leanToInput" id="leanToPitch0" type="text" value="2" disabled>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-e" onclick="leanToPitchRight(0)"></span>
					</br>
					<label for="leanToDrop0" style="padding-right:11px; visibility: hidden;" class="leanto-0">Drop</label>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-w" onclick="leanToDropLeft(0)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-0 leanToInput" id="leanToDrop0" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-e" onclick="leanToDropRight(0)"></span>
					</br>
					<label for="leanToCut10" style="padding-right:8px; visibility: hidden;" class="leanto-0">Cut 1</label>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-w" onclick="leanToCut1Left(0)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-0 leanToInput" id="leanToCut10" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-e" onclick="leanToCut1Right(0)"></span>
					</br>
					<label for="leanToCut20" style="padding-right:9px; visibility: hidden;" class="leanto-0">Cut 2</label>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-w" onclick="leanToCut2Left(0)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-0 leanToInput" id="leanToCut20" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-0 ui-icon ui-icon-circle-arrow-e" onclick="leanToCut2Right(0)"></span>
					</br>
					</br>
					<label for="leanToWrapLeft0" style="visibility: hidden; padding-right: 17px;" class="leanto-0">Wrap Left</label>
					<label style="visibility: hidden;" class="leanto-0 switch">
						<input style="visibility: hidden;" id="leanToWrapLeft0" type="checkbox" class="leanto-0" onclick="leanToWrapLeft(0)" disabled>
						<span style="visibility: hidden;" class="leanto-0 slider round"></span>
					</label>
					</br>
					<label for="leanToWrapRight0" style="visibility: hidden; padding-right: 8px;" class="leanto-0">Wrap Right</label>
					<label style="visibility: hidden;" class="leanto-0 switch">
						<input style="visibility: hidden;" id="leanToWrapRight0" type="checkbox" class="leanto-0" onclick="leanToWrapRight(0)" disabled>
						<span style="visibility: hidden;" class="leanto-0 slider round"></span>
					</label>
				</p>
			</div>
			...
			<div>
				<p>
					...
					<label for="leanToWidth1" style="padding-right:7px; visibility: hidden;" class="leanto-1">Width</label>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-w" onclick="leanToWidthLeft(1)"></span>
					<input style="width:25px; text-align:center;  visibility: hidden;" class="leanto-1 leanToInput" id="leanToWidth1" type="text" value="5" disabled>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-e" onclick="leanToWidthRight(1)"></span>
					</br>
					<label for="leanToPitch1" style="padding-right:10px; visibility: hidden;" class="leanto-1">Pitch</label>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-w" onclick="leanToPitchLeft(1)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-1 leanToInput" id="leanToPitch1" type="text" value="2" disabled>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-e" onclick="leanToPitchRight(1)"></span>
					</br>
					<label for="leanToDrop1" style="padding-right:11px; visibility: hidden;" class="leanto-1">Drop</label>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-w" onclick="leanToDropLeft(1)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-1 leanToInput" id="leanToDrop1" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-e" onclick="leanToDropRight(1)"></span>
					</br>
					<label for="leanToCut11" style="padding-right:8px; visibility: hidden;" class="leanto-1">Cut 1</label>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-w" onclick="leanToCut1Left(1)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-1 leanToInput" id="leanToCut11" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-e" onclick="leanToCut1Right(1)"></span>
					</br>
					<label for="leanToCut21" style="padding-right:9px; visibility: hidden;" class="leanto-1">Cut 2</label>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-w" onclick="leanToCut2Left(1)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-1 leanToInput" id="leanToCut21" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-1 ui-icon ui-icon-circle-arrow-e" onclick="leanToCut2Right(1)"></span>
					</br>
					</br>
					<label for="leanToWrapLeft1" style="visibility: hidden; padding-right: 17px;" class="leanto-1">Wrap Left</label>
					<label style="visibility: hidden;" class="leanto-1 switch">
						<input style="visibility: hidden;" id="leanToWrapLeft1" type="checkbox" class="leanto-1" onclick="leanToWrapLeft(1)" disabled>
						<span style="visibility: hidden;" class="leanto-1 slider round"></span>
					</label>
					</br>
					<label for="leanToWrapRight1" style="visibility: hidden; padding-right: 8px;" class="leanto-1">Wrap Right</label>
					<label style="visibility: hidden;" class="leanto-1 switch">
						<input style="visibility: hidden;" id="leanToWrapRight1" type="checkbox" class="leanto-1" onclick="leanToWrapRight(1)" disabled>
						<span style="visibility: hidden;" class="leanto-1 slider round"></span>
					</label>
				</p>
		  	</div>
		  	...
		  	<div>
				<p>
					...
					<label for="leanToWidth2" style="padding-right:7px; visibility: hidden;" class="leanto-2">Width</label>
					<span style="visibility: hidden;" class="leanto-2 ui-icon ui-icon-circle-arrow-w" onclick="leanToWidthLeft(2)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-2 leanToInput" id="leanToWidth2" type="text" value="5" disabled>
					<span style="visibility: hidden;" class="leanto-2 ui-icon ui-icon-circle-arrow-e" onclick="leanToWidthRight(2)"></span>
					</br>
					<label for="leanToPitch2" style="padding-right:10px; visibility: hidden;" class="leanto-2">Pitch</label>
					<span style="visibility: hidden;" class="leanto-2 ui-icon ui-icon-circle-arrow-w" onclick="leanToPitchLeft(2)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-2 leanToInput" id="leanToPitch2" type="text" value="2" disabled>
					<span style="visibility: hidden;" class="leanto-2 ui-icon ui-icon-circle-arrow-e" onclick="leanToPitchRight(2)"></span>
					</br>
					<label for="leanToDrop2" style="padding-right:11px; visibility: hidden;" class="leanto-2">Drop</label>
					<span style="visibility: hidden;" class="leanto-2 ui-icon ui-icon-circle-arrow-w" onclick="leanToDropLeft(2)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-2 leanToInput" id="leanToDrop2" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-2 ui-icon ui-icon-circle-arrow-e" onclick="leanToDropRight(2)"></span>
					</br>
					<label for="leanToCut12" style="padding-right:8px; visibility: hidden;" class="leanto-2">Cut 1</label>
					<span style="visibility: hidden;" class="leanto-2 ui-icon ui-icon-circle-arrow-w" onclick="leanToCut1Left(2)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-2 leanToInput" id="leanToCut12" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-2 ui-icon ui-icon-circle-arrow-e" onclick="leanToCut1Right(2)"></span>
					</br>
					<label for="leanToCut22" style="padding-right:9px; visibility: hidden;" class="leanto-2">Cut 2</label>
					<span style="visibility: hidden" class="leanto-2 ui-icon ui-icon-circle-arrow-w" onclick="leanToCut2Left(2)"></span>
					<input style="width:25px; text-align:center;  visibility: hidden;" class="leanto-2 leanToInput" id="leanToCut22" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-2 ui-icon ui-icon-circle-arrow-e" onclick="leanToCut2Right(2)"></span>
					</br>
					</br>
					<label for="leanToWrapLeft2" style="visibility: hidden; padding-right: 17px;" class="leanto-2">Wrap Left</label>
					<label style="visibility: hidden;" class="leanto-2 switch">
						<input style="visibility: hidden;" id="leanToWrapLeft2" type="checkbox" class="leanto-2" onclick="leanToWrapLeft(2)" disabled>
						<span style="visibility: hidden;" class="leanto-2 slider round"></span>
					</label>
					</br>
					<label for="leanToWrapRight2" style="visibility: hidden; padding-right: 8px;" class="leanto-2">Wrap Right</label>
					<label style="visibility: hidden;" class="leanto-2 switch">
						<input style="visibility: hidden;" id="leanToWrapRight2" type="checkbox" class="leanto-2" onclick="leanToWrapRight(2)" disabled>
						<span style="visibility: hidden;" class="leanto-2 slider round"></span>
					</label>
				</p>
			</div>
			...
			<div>
				<p>
					...
					<label for="leanToWidth3" style="padding-right:7px; visibility: hidden;" class="leanto-3">Width</label>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-w" onclick="leanToWidthLeft(3)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-3 leanToInput" id="leanToWidth3" type="text" value="5" disabled>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-e" onclick="leanToWidthRight(3)"></span>
					</br>
					<label for="leanToPitch3" style="padding-right:10px; visibility: hidden;" class="leanto-3">Pitch</label>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-w" onclick="leanToPitchLeft(3)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-3 leanToInput" id="leanToPitch3" type="text" value="2" disabled>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-e" onclick="leanToPitchRight(3)"></span>
					</br>
					<label for="leanToDrop3" style="padding-right:11px; visibility: hidden;" class="leanto-3">Drop</label>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-w" onclick="leanToDropLeft(3)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-3 leanToInput" id="leanToDrop3" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-e" onclick="leanToDropRight(3)"></span>
					</br>
					<label for="leanToCut13" style="padding-right:8px; visibility: hidden;" class="leanto-3">Cut 1</label>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-w" onclick="leanToCut1Left(3)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-3 leanToInput" id="leanToCut13" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-e" onclick="leanToCut1Right(3)"></span>
					</br>
					<label for="leanToCut23" style="padding-right:9px; visibility: hidden;" class="leanto-3">Cut 2</label>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-w" onclick="leanToCut2Left(3)"></span>
					<input style="width:25px; text-align:center; visibility: hidden;" class="leanto-3 leanToInput" id="leanToCut23" type="text" value="0" disabled>
					<span style="visibility: hidden;" class="leanto-3 ui-icon ui-icon-circle-arrow-e" onclick="leanToCut2Right(3)"></span>
					</br>
					</br>
					<label for="leanToWrapLeft3" style="visibility: hidden; padding-right: 17px;" class="leanto-3">Wrap Left</label>
					<label style="visibility: hidden;" class="leanto-3 switch">
						<input style="visibility: hidden;" id="leanToWrapLeft3" type="checkbox" class="leanto-3" onclick="leanToWrapLeft(3)" disabled>
						<span style="visibility: hidden;" class="leanto-3 slider round"></span>
					</label>
					</br>
					<label for="leanToWrapRight3" style="visibility: hidden; padding-right: 8px;" class="leanto-3">Wrap Right</label>
					<label style="visibility: hidden;" class="leanto-3 switch">
						<input style="visibility: hidden;" id="leanToWrapRight3" type="checkbox" class="leanto-3" onclick="leanToWrapRight(3)" disabled>
						<span style="visibility: hidden;" class="leanto-3 slider round"></span>
					</label>
				</p>
			</div>
			...
			<div>
				<p>
					...
					<button id="remWin0" style="visibility: hidden" type="button" onclick="removeWindow(0)">Remove</button>
					<span id="nWinArrow0" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-n" onclick="windowUp(0)"></span>
					<span id="sWinArrow0" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-s" onclick="windowDown(0)"></span>
					<span id="wWinArrow0" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-w" onclick="windowLeft(0)"></span>
					<span id="eWinArrow0" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-e" onclick="windowRight(0)"></span>
				</p>
				<p>
					<label>Right:</label>
					<button type="button" onclick="addWindow(1)">Add</button>
					<button id="remWin1" style="visibility: hidden" type="button" onclick="removeWindow(1)">Remove</button>
					<span id="nWinArrow1" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-n" onclick="windowUp(1)"></span>
					<span id="sWinArrow1" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-s" onclick="windowDown(1)"></span>
					<span id="wWinArrow1" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-w" onclick="windowLeft(1)"></span>
					<span id="eWinArrow1" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-e" onclick="windowRight(1)"></span>
				</p>
				<p>
					<label>Back:</label>
					<button type="button" onclick="addWindow(2)">Add</button>
					<button id="remWin2" style="visibility: hidden" type="button" onclick="removeWindow(2)">Remove</button>
					<span id="nWinArrow2" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-n" onclick="windowUp(2)"></span>
					<span id="sWinArrow2" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-s" onclick="windowDown(2)"></span>
					<span id="wWinArrow2" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-w" onclick="windowLeft(2)"></span>
					<span id="eWinArrow2" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-e" onclick="windowRight(2)"></span>
				</p>
				<p>
					<label style="padding-right: 8px;">Left: </label>
					<button type="button" onclick="addWindow(3)">Add</button>
					<button id="remWin3" style="visibility: hidden" type="button" onclick="removeWindow(3)">Remove</button>
					<span id="nWinArrow3" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-n" onclick="windowUp(3)"></span>
					<span id="sWinArrow3" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-s" onclick="windowDown(3)"></span>
					<span id="wWinArrow3" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-w" onclick="windowLeft(3)"></span>
					<span id="eWinArrow3" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-e" onclick="windowRight(3)"></span>
				</p>
			</div>
			<h3>Doors</h3>
			<div>
				...
				<p>
					<label>Front:</label>
					<button type="button" onclick="addDoor(0, document.querySelector('#DoorType').value)">Add</button>
					<button id="remDoor0" style="visibility: hidden" type="button" onclick="removeDoor(0)">Remove</button>
					<span id="wDoorArrow0" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-w" onclick="doorLeft(0)"></span>
					<span id="eDoorArrow0" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-e" onclick="doorRight(0)"></span>
				</p>
				<p>
					<label>Right:</label>
					<button type="button" onclick="addDoor(1, document.querySelector('#DoorType').value)">Add</button>
					<button id="remDoor1" style="visibility: hidden" type="button" onclick="removeDoor(1)">Remove</button>
					<span id="wDoorArrow1" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-w" onclick="doorLeft(1)"></span>
					<span id="eDoorArrow1" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-e" onclick="doorRight(1)"></span>
				</p>
				<p>
					<label>Back:</label>
					<button type="button" onclick="addDoor(2, document.querySelector('#DoorType').value)">Add</button>
					<button id="remDoor2" style="visibility: hidden" type="button" onclick="removeDoor(2)">Remove</button>
					<span id="wDoorArrow2" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-w" onclick="doorLeft(2)"></span>
					<span id="eDoorArrow2" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-e" onclick="doorRight(2)"></span>
				</p>
				<p>
					<label style="padding-right: 8px;">Left: </label>
					<button type="button" onclick="addDoor(3, document.querySelector('#DoorType').value)">Add</button>
					<button id="remDoor3" style="visibility: hidden" type="button" onclick="removeDoor(3)">Remove</button>
					<span id="wDoorArrow3" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-w" onclick="doorLeft(3)"></span>
					<span id="eDoorArrow3" style="visibility: hidden" class="ui-icon ui-icon-circle-arrow-e" onclick="doorRight(3)"></span>
				</p>
		  	</div>
			<h3>Finalize</h3>
		  	<div>
            	...
            	const holes = [];
            		for(var ii = 0; ii < windowSpaces[0].length; ii++) {
                		...
                		var wSpace = [
                			...
                			new BABYLON.Vector3(ws.left+walls[0].corner.x+ws.window.width, 0, height-ws.top-ws.window.height),
...
// 					colors.push(roofColor[0], roofColor[1], roofColor[2], 1);	}
        	...
        	var rebuildRoof = function() {
				...
				wholeRoofprint = roofprint(corners, (overlapLRFront+overlapLRBack), height-(overhangFB*0.095*roofHeight));
...
// 				roofFB.material.invertNormalMapX = true;
			...
			var rebuildWalls = function() { 
						...
						{	walls[d].doorSpaces.push(doorSpaces[d][ds]);	
							...
							switch (doors[d][ds].type)	{
								...
								case "6x7 Double Door":
									...
									break;
								case "8x8 Sectional":
									{ //scaling = new BABYLON.Vector3(2.2575, 2.728, 2);
				...
				house = buildFromPlan(walls, ply, height, {interiorUV: new BABYLON.Vector4(0, 0, (width*2+length*2)/4, (width*2+length*2)/4), exteriorUV: new BABYLON.Vector4(0, 0, (width*2+length*2)/4, (width*2+length*2)/4), interiorColor: new BABYLON.Color4(1,1,1,1), exteriorColor: new BABYLON.Color4(wallColor[0], wallColor[1], wallColor[2], 1)}, scene);
			...
			var buildWallTrim = function(){
				...
				for (c=0; c<corners.length; c++)	{	
					leftPlane = BABYLON.MeshBuilder.CreatePlane("wallTrim", {height:height, width: 0.25, sideOrientation: BABYLON.Mesh.DOUBLESIDE});
					...
					rightPlane = BABYLON.MeshBuilder.CreatePlane("wallTrim", {height:height, width: 0.25, sideOrientation: BABYLON.Mesh.DOUBLESIDE});
			...
			var buildRoofTrim = function(){
				...
				leftPlane = BABYLON.MeshBuilder.CreatePlane("roofTrim", {height:0.25, width: length+overhangLRFront+overhangLRBack, sideOrientation: BABYLON.Mesh.DOUBLESIDE});
				leftPlane.material = new BABYLON.StandardMaterial("", scene);
				leftPlane.material.diffuseColor = new BABYLON.Color3(roofColor[0], roofColor[1], roofColor[2]);

				rightPlane = BABYLON.MeshBuilder.CreatePlane("roofTrim", {height:0.25, width: length+overhangLRFront+overhangLRBack, sideOrientation: BABYLON.Mesh.DOUBLESIDE});
				rightPlane.material = new BABYLON.StandardMaterial("", scene);
				...
				for (ii=0; ii<corners.length; ii++)	{	
					switch (ii) {
						case 0:	{
							leftPlane = BABYLON.MeshBuilder.CreatePlane("roofTrim", {height:0.25, width: c, sideOrientation: BABYLON.Mesh.DOUBLESIDE});
							leftPlane.material = new BABYLON.StandardMaterial("", scene);
							leftPlane.material.diffuseColor = new BABYLON.Color3(trimColor[0], trimColor[1], trimColor[2]);

							rightPlane = BABYLON.MeshBuilder.CreatePlane("roofTrim", {height:0.25, width: c, sideOrientation: BABYLON.Mesh.DOUBLESIDE});
							rightPlane.material = new BABYLON.StandardMaterial("", scene);
							rightPlane.material.diffuseColor = new BABYLON.Color3(trimColor[0], trimColor[1], trimColor[2]);
						...
						case 1:	{
							leftPlane = BABYLON.MeshBuilder.CreatePlane("roofTrim", {height:0.25, width: length, sideOrientation: BABYLON.Mesh.DOUBLESIDE});
							leftPlane.material = new BABYLON.StandardMaterial("", scene);
							leftPlane.material.diffuseColor = new BABYLON.Color3(trimColor[0], trimColor[1], trimColor[2]);
...
// 							rightPlane.rotation.x = 1.5708-roofAngle;
			...
			var loadWindowModel = function(){
					...
					windowMeshNames = ["casing", 		"jam", 			"lower_sash", 	"glass_lower_sash", 	"upper_sash", 	"sash_lock", 	"glass_upper_sash",
			...
			var load3x7DoorModel = function()	{
				...
				door3x7MeshNames = ["frame_010_Plane.015",			"floor_plate_010_Cube.002",			"door_010_Cylinder.003",				"handle_010_Cylinder.016",
								 	"closer_door_010_Cube.006",		"closer_hinge_door_010_Cube.007", 	"closer_hinge_frame_010_Cylinder.010",	"closer_frame_010_Plane" ];
			};
			...
			var load4x7DoorModel = function()	{
				...
				door4x7MeshNames = ["frame_4x7_Plane.015",			"floor_plate_4x7_Cube.002",			"door_4x7_Cylinder.003",				"handle_4x7_Cylinder.016",
								 	"closer_door_4x7_Cube.006",		"closer_hinge_door_4x7_Cube.007", 	"closer_hinge_frame_4x7_Cylinder.010",	"closer_frame_4x7_Plane" ];
			...
			var load6x7DoorModel = function()	{
				...
				door6x7MeshNames = ["frame_014_Plane.018",              "floor_plate_double_014_Cube.031",          "door_B_014_Cylinder.032",              "closer_door_B_014_Cube.042",
                                    "closer_hinge_door_B_014_Cube.043", "closer_hinge_frame_B_014_Cylinder.064",    "closer_frame_B_014_Plane.024",         "handle_B_014_Cylinder.033",
                                    "door_A_014_Cylinder.005",          "closer_door_A_014_Cube.040",               "closer_hinge_door_A_014_Cube.041",     "closer_hinge_frame_A_014_Cylinder.063",
			...
			var place6x7EDoorModel = function(wall, door, doorSpace)	{
				...
				for(var i = 0; i < meshCount; i++){
					...
					if (door6x7MeshNames.includes(scene.meshes[i].name) == true ) {
						...
						var mesh2 = scene.meshes[i].clone(scene.meshes[i].name+i);
						if (scene.meshes[i].name == "handle_A_014_Cylinder.030" 		||	scene.meshes[i].name == "handle_B_014_Cylinder.033" ||
							scene.meshes[i].name == "closer_hinge_door_B_014_Cube.043" 	|| 	scene.meshes[i].name == "closer_hinge_frame_B_014_Cylinder.064" ||
							scene.meshes[i].name == "closer_frame_B_014_Plane.024" 		|| 	scene.meshes[i].name == "closer_door_A_014_Cube.040" ||
							scene.meshes[i].name == "closer_hinge_door_A_014_Cube.041" 	|| 	scene.meshes[i].name == "closer_hinge_frame_A_014_Cylinder.063" ||
							scene.meshes[i].name == "closer_door_B_014_Cube.042" 		|| 	scene.meshes[i].name == "closer_frame_A_014_Plane.023")  {
							mesh2.material = new BABYLON.StandardMaterial("", scene);
							mesh2.material.diffuseColor = new BABYLON.Color3(0.667, 0.675, 0.698);
						}
						doorMeshes.push(scene.meshes[i].name+i)
			...
			var placeSectionalDoorModel = function(wall, d, ds, scaling, frameScaling)	{
				...
				var meshes = [];
				for(var i = 0; i < meshCount; i++){
					if (scene.meshes[i].name == 'garage_door_mechanism_Cube.001' || scene.meshes[i].name == 'garage_door_Cube' || scene.meshes[i].name == "frame_014_Plane.018") {
			...
			var buildFloor = function(){
				...
				floor = BABYLON.MeshBuilder.CreateGround("ground", {width:width+2+leanTo[1].width+leanTo[3].width, height:length+2+Math.max(overhangLRFront, leanTo[0].width)+Math.max(overhangLRBack, leanTo[2].width), updatable: true}); 
				...
				floor.position.z = (length/2)-((Math.max(overhangLRFront, leanTo[0].width)-Math.max(overhangLRBack, leanTo[2].width))/2);
			...
			var buildPosts = function() {
				...
				if (overhangLRFront > 0) {
					post = BABYLON.MeshBuilder.CreateBox("post", {height:height, width:1/3, depth:1/3}, scene);
...
// 					}
			...
			var buildLeanTo = function(wall){
				...
				switch (wall)	{
					case 0:	{
						if (leanTo[wall].wrapLeft ==1)	{
							...
							newCorners[0] = new BABYLON.Vector3(corners[0].x+leanTo[wall].cut1, 0, 0-leanTo[wall].width);
						}
						if (leanTo[wall].wrapRight ==1)	{
							newCorners[1] = new BABYLON.Vector3(corners[1].x+leanTo[1].width, 0, 0-leanTo[wall].width);
						}
						else {
							newCorners[1] = new BABYLON.Vector3(corners[1].x-leanTo[wall].cut2, 0, 0-leanTo[wall].width);
						}
					...
					case 1:	{
						if (leanTo[wall].wrapLeft ==1)	{
							...
							newCorners[0] = new BABYLON.Vector3(corners[1].x+leanTo[wall].width, 0, 0+leanTo[wall].cut1);
						}
						if (leanTo[wall].wrapRight ==1)	{
							newCorners[1] = new BABYLON.Vector3(corners[2].x+leanTo[wall].width, 0, 0+length+leanTo[2].width);
						}
						else {
							newCorners[1] = new BABYLON.Vector3(corners[2].x+leanTo[wall].width, 0, 0+length-leanTo[wall].cut2);
						}
					...
					case 2:	{
						if (leanTo[wall].wrapLeft ==1)	{
							newCorners[0] = new BABYLON.Vector3(corners[2].x+leanTo[1].width, 0, length+leanTo[wall].width);
						}
						else {
							newCorners[0] = new BABYLON.Vector3(corners[2].x-leanTo[wall].cut1, 0, length+leanTo[wall].width);
						}
						if (leanTo[wall].wrapRight ==1)	{
							newCorners[1] = new BABYLON.Vector3(corners[3].x-leanTo[3].width, 0, length+leanTo[wall].width);
						}
						else {
							newCorners[1] = new BABYLON.Vector3(corners[3].x+leanTo[wall].cut2, 0, length+leanTo[wall].width);
						}
					...
					case 3:	{
						if (leanTo[wall].wrapLeft ==1)	{
							newCorners[0] = new BABYLON.Vector3(corners[3].x-leanTo[wall].width, 0, length+leanTo[2].width);
						}
						else {
							newCorners[0] = new BABYLON.Vector3(corners[3].x-leanTo[wall].width, 0, length-leanTo[wall].cut1);
						}
						if (leanTo[wall].wrapRight ==1)	{
							newCorners[1] = new BABYLON.Vector3(corners[0].x-leanTo[wall].width, 0, 0-leanTo[0].width);
						}
						else {
							newCorners[1] = new BABYLON.Vector3(corners[0].x-leanTo[wall].width, 0, 0+leanTo[wall].cut2);
						}
				...
				switch (wall)	{
					case 0:	{
						...
						fLeanToMesh = roof(wholeRoofprint, apexes, planesLT, leanTo[wall].pitch*0.5, rHeight, 5.6, fLeanToMesh, "fLeanToMesh"+wall );
					...
					case 1:	{
						...
						rLeanToMesh = roof(wholeRoofprint, apexes, planesLT, leanTo[wall].pitch*0.5, rHeight, 5.6, rLeanToMesh, "rLeanToMesh"+wall );
					...
					case 2:	{
						...
						bLeanToMesh = roof(wholeRoofprint, apexes, planesLT, leanTo[wall].pitch*0.5, rHeight, 5.6, bLeanToMesh, "bLeanToMesh"+wall );
					...
					case 3:	{
						...
						lLeanToMesh = roof(wholeRoofprint, apexes, planesLT, leanTo[wall].pitch*0.5, rHeight, 5.6, lLeanToMesh, "lLeanToMesh"+wall );
			...
			var buildLeanToPosts = function(wall) {
				...
				if (leanTo[wall].width > 0) {
					post = BABYLON.MeshBuilder.CreateBox("post", {height:height-leanTo[wall].drop-(leanTo[wall].pitch*0.5), width:1/3, depth:1/3}, scene);
					post.material = new BABYLON.StandardMaterial("", scene);
					post.material.diffuseColor = new BABYLON.Color3(wallColor[0], wallColor[1], wallColor[2]);
					switch (wall)	{
						case 0:	{
					...
					if (wall %2 == 0)	{
						...
						if (leanToLength > 50)	{
							...
							post.material = new BABYLON.StandardMaterial("", scene);
							post.material.diffuseColor = new BABYLON.Color3(wallColor[0], wallColor[1], wallColor[2]);
							post.position.x = 0-(Math.abs(leanToCorners[wall][0].x)+Math.abs(leanToCorners[wall][1].x))/3/2;
							if (wall == 0)	{
								post.position.z = leanToCorners[wall][1].z+0.2;
							}
							else	{
							...
							for(var i = 0; i < numPosts-1; i++) {
								...
								switch (wall)	{
									case 1:	{
										post.position.x = leanToCorners[wall][1].x-0.2;
										if (leanTo[wall].wrapLeft)	{
											post.position.z = (leanToCorners[wall][1].z-leanToCorners[wall][0].z)/parseFloat(numPosts)*(i+1)-leanTo[0].width;
										}
										else {
											post.position.z = (leanToCorners[wall][1].z-leanToCorners[wall][0].z)/parseFloat(numPosts)*(i+1);
										}											
										break;
									}
									case 3:	{
										post.position.x = leanToCorners[wall][1].x+0.2;
										if (leanTo[wall].wrapRight)	{
											post.position.z = (leanToCorners[wall][0].z-leanToCorners[wall][1].z)/parseFloat(numPosts)*(i+1)-leanTo[0].width;
										}
										else {
											post.position.z = (leanToCorners[wall][0].z-leanToCorners[wall][1].z)/parseFloat(numPosts)*(i+1);
										}
										break;
									}
								}
			...
			var disposeLeanTo = function(wall)	{
				switch (wall)	{
					case 0:	{
						if (fLeanToMesh != null) { fLeanToMesh.dispose(); }
						break;
					}
					case 1:	{
						if (rLeanToMesh != null) { rLeanToMesh.dispose(); }
						break;
					}
					case 2:	{
						if (bLeanToMesh != null) { bLeanToMesh.dispose(); }
						break;
					}
					case 3:	{
						if (lLeanToMesh != null) { lLeanToMesh.dispose(); }
						break;
					}
				}
			...
			var windowLeft = function( wall ){
				...
				windowSpaces[wall][windowSpaces[wall].length-1].left = windowSpaces[wall][windowSpaces[wall].length-1].left - 0.5;
				w = defaultWindow;
			...
			var windowUp = function( wall ){
				...
				windowSpaces[wall][windowSpaces[wall].length-1].top = windowSpaces[wall][windowSpaces[wall].length-1].top - 0.5;
				w = defaultWindow;
				ws = windowSpaces[wall][windowSpaces[wall].length-1];
				if (checkWindowMovement(wall,ws,w) == true)	{
					rebuildWalls(house);
			...
			var addDoor = function( wall, doorSize ) {
				...
				if (wall %2 == 0) { doorLimit = width; }

				if (doorSpaces[wall].length == 0) 
				{	ds = new doorSpace(defaultDoor, dsLeft);
					while ( checkDoorPosition(wall, ds, defaultDoor) == false &&  dsLeft+defaultDoor.width < doorLimit+1 )	{
						dsLeft += 1;
						ds = new doorSpace(defaultDoor, dsLeft);
					}
					switch (wall)	{
				...
				{	ds0 = doorSpaces[wall][doorSpaces[wall].length-1];
					...
					while ( checkDoorPosition(wall, ds1, defaultDoor) == false &&  dsLeft+defaultDoor.width < doorLimit+1 )	{
						dsLeft += 1;
						ds1 = new doorSpace(defaultDoor, dsLeft);
					}
					switch (wall)	{
			...
			var checkDoorPosition = function(wall, doorSpace, door, isMoving=false)	{
				...
				if (doorSpaces[wall].length > 0)	{
					for(ds=0; ds<doorCount; ds++) {
						...
						d = doors[wall][ds];
						if (dSpace.left+d.width+1 > doorSpace.left)	{ return false; }		
					}
				}
				...
				if (windowSpaces[wall].length > 0)	{
					for(ws=0; ws<windowCount; ws++) {
						...
						w = defaultWindow;
						if (wSpace.left+w.width+1 > doorSpace.left && wSpace.top+w.height+1 > height-door.height)	{ return false; }		
					}
				}
				return true;
			};
			...
			var checkWindowPosition = function(wall, windowSpace, window )	{
				...
				newCorners.push(c);
				c = new corner(windowSpace.left+spacing+window.width, height-windowSpace.top-window.height-spacing);
				newCorners.push(c);
					...
					if (windowSpaces[wall].length > 0)	{
						for(ws=0; ws<windowCount; ws++) {
							...
							for (i=0; i<newCorners.length; i++)	{
								...
								else if (windowSpace.left == wSpace.left+w.width+spacing || wSpace.left == windowSpace.left+w.width+spacing)	{
									if (   newCorners[i].x >= wCorners[0].x && newCorners[i].z > wCorners[0].z
										&& newCorners[i].x <= wCorners[1].x && newCorners[i].z > wCorners[1].z
										&& newCorners[i].x <= wCorners[2].x && newCorners[i].z < wCorners[2].z
										&& newCorners[i].x >= wCorners[3].x && newCorners[i].z < wCorners[3].z	)
			...
			var doorLeft = function( wall ){
				...
				doorSpaces[wall][doorSpaces[wall].length-1].left = doorSpaces[wall][doorSpaces[wall].length-1].left - 0.5;
			...
			var checkLeanToWrapLeft = function(wall){
				if (leanTo[wall].drop == leanTo[getWallLeft(wall)].drop && leanTo[wall].cut1 == 0 && leanTo[getWallLeft(wall)].cut2 == 0 && leanTo[wall].pitch == leanTo[getWallLeft(wall)].pitch && leanTo[wall].width == leanTo[getWallLeft(wall)].width)	{
					s = 'leanToWrapLeft'+wall;
			...
			var checkLeanToWrapRight = function(wall){
				if (leanTo[wall].drop == leanTo[getWallRight(wall)].drop && leanTo[wall].cut1 == 0 && leanTo[getWallRight(wall)].cut2 == 0 && leanTo[wall].pitch == leanTo[getWallRight(wall)].pitch && leanTo[wall].width == leanTo[getWallRight(wall)].width)	{
					s = 'leanToWrapRight'+wall;
					document.querySelector('#'+s).disabled = false;
				}
				else
			...
			var captureScreen = function()	{
				BABYLON.Tools.CreateScreenshotUsingRenderTarget(engine, scene.activeCamera, {width:800, height:400, precision:4});
			};
			...
			var showFL = function(){
				fl = $.featherlight($('#mylightbox'), {persist:true});
				fl.open();
			};
        ...
        var createScene = function() {
			...
			scene.collisionsEnabled = true;
          	...
          	zoomCamera = new BABYLON.ArcRotateCamera("zoomCamera", -Math.PI/2, Math.PI / 3, 25, new BABYLON.Vector3(0, 5, -8), scene);
			...
			arcCamera = new BABYLON.ArcRotateCamera("arcCamera", -Math.PI/2, Math.PI / 3, 25, new BABYLON.Vector3(0, 5, -8), scene);
...
//             direc5.specular = BABYLON.Color3.Black();
			...
			ground = BABYLON.MeshBuilder.CreateGround("ground", {width:1000, height:1000});
			...
			$('#TrimColor').change(function() {
				...
				for(var i = meshCount; i >= 0; i--){
					if (scene.meshes[i].name.includes("frame_010_Plane.015") ) {
						scene.meshes[i].material.diffuseColor = new BABYLON.Color3(trimColor[0],trimColor[1],trimColor[2]);
					}
			...
			var buildQuoteEmail = function(){
				...
				for (w=0; w<4; w++)	{
        			...
        			for (var ws = 0; ws < numWindows; ws++) {			
        				emailText = emailText + "<p>"+ walls[w].windowSpaces[ws].left +" ft from left "+ walls[w].windowSpaces[ws].top +" ft from top</p>";
        			}
				}
				...
				for (w=0; w<4; w++)	{
        			...
        			for (var d = 0; d < numDoors; d++) {			
        				emailText = emailText + "<p>"+ walls[w].doorSpaces[d].door.type +" - "+ walls[w].doorSpaces[d].left +" ft from left</p>";
        			}
				}
